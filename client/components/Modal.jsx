      ...
      <div className="ModalPage">
        ...
        <span class="close" onClick={() => {console.log('close clicked');props.closeModal()}}>&times;</span>
          ...
          <form className='modalForm'>
            ...
            <input className="ModalInput" id="company" name="company" type="text"></input>
            <label className='ModalLabel' htmlFor="jobTitle">Job Title: </label>
            <input className="ModalInput" id="title" name="title" type="text"></input>
            <label className='ModalLabel' htmlFor="link">Link: </label>
            <input className="ModalInput" id="link" name="link" type="text"></input>
            <label className='ModalLabel' htmlFor="submission">Submission Method:</label>
            ...
            <label className='ModalLabel' htmlFor="submitDate">Date Submitted: </label>
            <input className="ModalInput" id="submitDate" name="submitDate" type="text"></input>
            <label className='ModalLabel' htmlFor="Resume">Resume name: </label>
            <input className="ModalInput" id="Resume" name="Resume" type="text"></input>
            <label className='ModalLabel' htmlFor="progress">Progress Status: </label>
            <input className="ModalInput" id="progress" name="progress" type="text"></input>
